...
p_load("here", "dplyr", "devtools", "scales", "ellipse", "ggplot2", "lazyeval", "igraph", "ggraph", "reshape2", "knitr", "citr", "plyr", "stats", "diagram", "EnvStats", "data.table", "gridExtra","ggrepel","tableone")   
...
df_icm <- expand.grid(Pop = unique(df_results_pooled$Label),  # Disease name 
                        QALY_med = NA,
                        QALY_lo = NA,
                        QALY_hi = NA,
                        bnft_med = NA,
...
df_icm[1:6, 1:10] # Print the first part
...
df_icm <- df_icm[, -8] # Remove the column with the loss of the first week as loss week 2 is considered surgery now
