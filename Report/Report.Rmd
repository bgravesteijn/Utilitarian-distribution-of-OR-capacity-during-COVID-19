...
plot_psa <- ggplot(plotpsa.df, 
  ...
  labs(x = "", y = "Distribution of parameter value PSA", fill = "Treatment") +
...
ggsave(bnft_v2,filename = "../../OR-decision-model/Manuscript/Submissions/Value in Health/Revision 1/Fig3.png", width=15, height=10)
...
ggsave(urg_v2,filename = "../../OR-decision-model/Manuscript/Submissions/Value in Health/Revision 1/Fig4.png", width=15, height=10)
