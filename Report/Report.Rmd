...
plot_descend_steiler <- ggplot(desc_df_steaper, 
...
plot_descend_steiler

plot_descend_vlakker <- ggplot(desc_df_flatter, 
       aes(x = delay, y = QALY_med - std, col = Label))+
  geom_line(cex = 2) + theme_bw() + theme(legend.position = "bottom", text=element_text(size = 18))+
  geom_vline(xintercept = seq(12,42, by=10), lty=2)+
  labs(x = "Delay (weeks)", y="QALYs - mean QALYs", col="Procedure")
plot_descend_vlakker
...
# Save the figures 
ggsave(plot_descend_vlakker, filename = "../figures/main_results/descend_vlakker.png", device = "png", 
       width = 15, height=10)
ggsave(plot_descend_steiler, filename = "../figures/main_results/descend_steiler.png", device = "png", 
       width = 15, height=10)
...
for(p in unique(urg$Label)){
  ...
  df_icm[df_icm[, (n_weeks_loss[1:t2]) & t1 == 2]] <- loss_icm$loss
