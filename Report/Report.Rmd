...
# Save the figures 
ggsave(plot_descend_flatter, filename = "../figures/main_results/descend_steiler.png", device = "png", 
       width = 15, height = 10)
ggsave(plot_descend_steaper, filename = "../figures/main_results/descend_vlakker.png", device = "png", 
       width = 15, height = 10)
...
urg_v2 <- ggplot(urg2, aes(x = Label, y = urg, ymin = urg_lo, ymax = urg_hi)) +
  ...
  facet_wrap_custom(~type, scales = "free_x", scale_overrides = list(
    scale_override(1, scale_y_continuous(limits = c(-0.4, 0),
                                         breaks = seq(from = -0.4, to = 0,by = 0.05),
                                         labels = seq(from = 0.4,  to = 0,by = -0.05), 
                     expand = c(0, 0))),
    scale_override(2, scale_y_continuous(limits = c(0, 0.4),
                                         breaks = seq(from = 0, to = 0.4,by = 0.05),
                                         labels = seq(from = 0, to = 0.4,by = 0.05), 
                     expand = c(0, 0)))
  ))+
  coord_flip() +
  theme_bw() +
